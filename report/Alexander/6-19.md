...
```
### 3.3 Single‑Case Execution and Comparison
...
### 3.4 Batch Test-Case Comparison
- **Batch script**: 
...
### 4.1 KLEE Test-Case Generation Statistics

- **Total cases generated**: 9
- **Valid cases**: 7

### 4.2 Single-Case Comparison Example

| Test Case Input | C Result (c_result) | Rust Result (rust_result) | Match? |
|-----------------|---------------------|---------------------------|--------|
| 2              | Study              | Study                    | yes    |

### 4.3 Batch Test Results Summary
